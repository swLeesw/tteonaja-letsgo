...
--
-- Dumping data for table `attraction_comment`
--

LOCK TABLES `attraction_comment` WRITE;
/*!40000 ALTER TABLE `attraction_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `attraction_comment` ENABLE KEYS */;
UNLOCK TABLES;
